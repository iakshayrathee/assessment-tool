...
import massAssessmentRoutes from './routes/massAssessment';
...
app.use(cors({
  origin: [
    ...
    'https://knowledai.vercel.app',
    'https://assessment-tool-dev.vercel.app'
  ],
  credentials: true,
...
app.use('/api/mass-assessment', massAssessmentRoutes);
