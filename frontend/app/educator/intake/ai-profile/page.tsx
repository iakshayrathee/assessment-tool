...
function AIProfileContent() {
  ...
  const buildPayload = () => {
    ...
    if (form.student?.age || form.mediumOfInstruction || form.student?.motherTongue) tabs_completed.push('demographics');
    ...
    if (form.epilepticHistory !== null || form.onMedication !== null) tabs_completed.push('medical');
    if (form.attendedPreschool !== null) tabs_completed.push('educational');
